"""
Non-interactive setup script for the AI Quiz application.
...
def create_default_superuser():
    """Create a default superuser for accessing the admin panel."""
    ...
    print("Default superuser 'admin' created successfully with password 'adminpassword'.")
